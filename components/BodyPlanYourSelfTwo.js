        ...
        <div className={styles.content__contanier__area}>
          ...
          <div className={styles.progressBar__container__area}>
            <div className={styles.scroller__contanier}>
              <p>No.of common washroom outside</p>
              <ProgressBar />
            </div>
            <div className={styles.scroller__contanier}>
              <p>No.of common washroom inside</p>
              <ProgressBar />
            </div>
            <div className={styles.scroller__contanier}>
              <p>No.of common washroom attached</p>
              <ProgressBar />
            </div>
          </div>
...
export default BodyPlanYourSelfTwo;
