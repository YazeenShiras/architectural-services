      ...
      <div className={styles.image__section__container}>
        ...
        <div id="whatWeDo" className={styles.whatWeDo__section}>
          ...
          <p>
            ...
            construction professionals means that we can provide a complete
            service from conception to completion including the delivery of
            detailed plans, specifications and drawings. We pride ourselves on
